          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" name="tweeter" class="form-control" value="{{ $item->tweeter }}"/>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" name="instagram" class="form-control" value="{{ $item->instagram }}"/>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <input type="text" name="pinterest" class="form-control" value="{{ $item->pinterest }}"/>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <img id="showImage" src="{{ asset($item->image) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="90">
                </div>
              </div>
