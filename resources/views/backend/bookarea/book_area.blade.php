        ...
        <div class="col-lg-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                <div class="col-sm-3">
                  <h6 class="mb-0">Main Title <span class="text-danger">*</span></h6>
                </div>
                <div class="form-group col-sm-9 text-secondary">
              ...
              <div class="row mb-3">
                <div class="col-sm-3">
                  <h6 class="mb-0">Short Description</h6> <span class="text-danger">*</span></h6>
                </div>
                <div class="form-group col-sm-9 text-secondary">
              ...
              <div class="row mb-3">
                <div class="col-sm-3">
                  <h6 class="mb-0">Link URL <span class="text-danger">*</span></h6>
                </div>
                <div class="form-group col-sm-9 text-secondary">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  <img id="showImage" src="{{ asset($book->image) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="90">
                </div>
              </div>
