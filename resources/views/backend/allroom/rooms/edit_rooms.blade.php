...
<div class="page-content">
  ...
  <div class="col-md-6">
    ...
    <img id="showImage" src="{{ (!empty($editData->image)) ? url('upload/roomimg/'.$editData->image) : url('upload/no_image.jpg') }}" alt="Admin" class="bg-primary" width="80">
  ...
  <div class="col-md-6">
    ...
    <select id="input7" class="form-select">
      <option name="beg_style" selected="">Choose...</option>
